...
const HomePage = () => {
  ...
  const [guideStep, setGuideStep] = useState(false); // Mengontrol apakah guide sudah tampil
  const guideRef = useRef(null); // Gunakan ref untuk referensi card

  // Fungsi untuk mengubah state dan scroll ke card saat tombol "Pelajari Lebih Lanjut" diklik
